    ...
    (<div
      ...
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-96 overflow-visible w-[30rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]">
          <div
      ...
      <div className="relative z-50 flex -translate-y-80 flex-col items-center px-5 h-[25rem]">
        {children}
      </div>
    </div>)
  );
